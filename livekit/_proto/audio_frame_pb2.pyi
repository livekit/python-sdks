...
class CaptureAudioFrameRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["buffer_handle", b"buffer_handle", "source_handle", b"source_handle"]) -> builtins.bool: ...
...
class RemixAndResampleRequest(google.protobuf.message.Message):
    ...
    SAMPLE_RATE_FIELD_NUMBER: builtins.int
    @property
    def resampler_handle(self) -> handle_pb2.FfiHandleId: ...
    @property
    def buffer_handle(self) -> handle_pb2.FfiHandleId: ...
    num_channels: builtins.int
    sample_rate: builtins.int
    def __init__(
        self,
        *,
        resampler_handle: handle_pb2.FfiHandleId | None = ...,
        buffer_handle: handle_pb2.FfiHandleId | None = ...,
        num_channels: builtins.int = ...,
        sample_rate: builtins.int = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["buffer_handle", b"buffer_handle", "resampler_handle", b"resampler_handle"]) -> builtins.bool: ...
