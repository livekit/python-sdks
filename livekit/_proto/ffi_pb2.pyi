...
class FfiRequest(_message.Message):
    __slots__ = ["initialize", "dispose", "connect", "disconnect", "publish_track", "unpublish_track", "create_video_track", "create_audio_track", "alloc_video_buffer", "new_video_stream", "new_video_source", "capture_video_frame", "to_i420", "to_argb", "alloc_audio_buffer", "new_audio_stream", "new_audio_source", "capture_audio_frame", "new_audio_resampler", "remix_and_resample"]
...
class FfiEvent(_message.Message):
    __slots__ = ["room_event", "track_event", "participant_event", "video_stream_event", "audio_stream_event", "connect", "dispose", "publish_track"]
