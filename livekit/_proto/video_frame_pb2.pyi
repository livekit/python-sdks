...
class _VideoFrameBufferTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_VideoFrameBufferType.ValueType], builtins.type):
    ...
    WEBGL: _VideoFrameBufferType.ValueType  # 7
...
WEBGL: VideoFrameBufferType.ValueType  # 7
...
class NewVideoStreamResponse(google.protobuf.message.Message):
    ...
    @property
    def stream(self) -> global___VideoStreamInfo: ...
    def __init__(
        self,
        *,
        stream: global___VideoStreamInfo | None = ...,
    ) -> None: ...
...
class NewVideoSourceRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_resolution", b"_resolution", "resolution", b"resolution", "type", b"type"]) -> None: ...
...
class NewVideoSourceResponse(google.protobuf.message.Message):
    ...
    @property
    def source(self) -> global___VideoSourceInfo: ...
    def __init__(
        self,
        *,
        source: global___VideoSourceInfo | None = ...,
    ) -> None: ...
...
class CaptureVideoFrameRequest(google.protobuf.message.Message):
    ...
    @property
    def source_handle(self) -> handle_pb2.FfiHandleId: ...
    @property
    def frame(self) -> global___VideoFrameInfo: ...
    @property
    def buffer_handle(self) -> handle_pb2.FfiHandleId: ...
    def __init__(
        self,
        *,
        source_handle: handle_pb2.FfiHandleId | None = ...,
        frame: global___VideoFrameInfo | None = ...,
        buffer_handle: handle_pb2.FfiHandleId | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["buffer_handle", b"buffer_handle", "frame", b"frame", "source_handle", b"source_handle"]) -> builtins.bool: ...
...
class ToI420Request(google.protobuf.message.Message):
    ...
    @property
    def buffer(self) -> handle_pb2.FfiHandleId: ...
    def __init__(
        self,
        *,
        flip_y: builtins.bool = ...,
        argb: global___ARGBBufferInfo | None = ...,
        buffer: handle_pb2.FfiHandleId | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["argb", b"argb", "buffer", b"buffer", "from", b"from"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["argb", b"argb", "buffer", b"buffer", "flip_y", b"flip_y", "from", b"from"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["from", b"from"]) -> typing_extensions.Literal["argb", "buffer"] | None: ...
...
class VideoFrameBufferInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["bi_yuv", b"bi_yuv", "buffer", b"buffer", "handle", b"handle", "native", b"native", "yuv", b"yuv"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["bi_yuv", b"bi_yuv", "buffer", b"buffer", "buffer_type", b"buffer_type", "handle", b"handle", "height", b"height", "native", b"native", "width", b"width", "yuv", b"yuv"]) -> None: ...
...
class VideoStreamEvent(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["frame_received", b"frame_received", "handle", b"handle", "message", b"message"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["frame_received", b"frame_received", "handle", b"handle", "message", b"message"]) -> None: ...
