...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ANALYTICSSTAT'].fields_by_name['room_id']._loaded_options = None
  _globals['_ANALYTICSSTAT'].fields_by_name['room_id']._serialized_options = b'\232\354,\006roomID'
  _globals['_ANALYTICSSTAT'].fields_by_name['participant_id']._loaded_options = None
  _globals['_ANALYTICSSTAT'].fields_by_name['participant_id']._serialized_options = b'\232\354,\rparticipantID'
  _globals['_ANALYTICSSTAT'].fields_by_name['track_id']._loaded_options = None
  _globals['_ANALYTICSSTAT'].fields_by_name['track_id']._serialized_options = b'\232\354,\007trackID'
  _globals['_ANALYTICSEVENT'].fields_by_name['room_id']._loaded_options = None
  _globals['_ANALYTICSEVENT'].fields_by_name['room_id']._serialized_options = b'\232\354,\006roomID'
  _globals['_ANALYTICSEVENT'].fields_by_name['participant_id']._loaded_options = None
  _globals['_ANALYTICSEVENT'].fields_by_name['participant_id']._serialized_options = b'\232\354,\rparticipantID'
  _globals['_ANALYTICSEVENT'].fields_by_name['track_id']._loaded_options = None
  _globals['_ANALYTICSEVENT'].fields_by_name['track_id']._serialized_options = b'\232\354,\007trackID'
  _globals['_ANALYTICSEVENT'].fields_by_name['egress_id']._loaded_options = None
  _globals['_ANALYTICSEVENT'].fields_by_name['egress_id']._serialized_options = b'\232\354,\010egressID'
  _globals['_ANALYTICSEVENT'].fields_by_name['ingress_id']._loaded_options = None
  _globals['_ANALYTICSEVENT'].fields_by_name['ingress_id']._serialized_options = b'\232\354,\tingressID'
  _globals['_ANALYTICSEVENT'].fields_by_name['node_id']._loaded_options = None
  _globals['_ANALYTICSEVENT'].fields_by_name['node_id']._serialized_options = b'\232\354,\006nodeID'
  _globals['_ANALYTICSEVENT'].fields_by_name['sip_call_id']._loaded_options = None
  _globals['_ANALYTICSEVENT'].fields_by_name['sip_call_id']._serialized_options = b'\232\354,\tsipCallID'
  _globals['_ANALYTICSEVENT'].fields_by_name['sip_trunk_id']._loaded_options = None
  _globals['_ANALYTICSEVENT'].fields_by_name['sip_trunk_id']._serialized_options = b'\232\354,\nsipTrunkID'
  _globals['_ANALYTICSEVENT'].fields_by_name['sip_dispatch_rule_id']._loaded_options = None
  _globals['_ANALYTICSEVENT'].fields_by_name['sip_dispatch_rule_id']._serialized_options = b'\232\354,\021sipDispatchRuleID'
  _globals['_ANALYTICSROOM'].fields_by_name['project_id']._loaded_options = None
  _globals['_ANALYTICSROOM'].fields_by_name['project_id']._serialized_options = b'\232\354,\tprojectID'
  _globals['_ANALYTICSNODEROOMS'].fields_by_name['node_id']._loaded_options = None
  _globals['_ANALYTICSNODEROOMS'].fields_by_name['node_id']._serialized_options = b'\232\354,\006nodeID'
  _globals['_FEATUREUSAGEINFO_FEATUREINFOENTRY']._loaded_options = None
  _globals['_FEATUREUSAGEINFO_FEATUREINFOENTRY']._serialized_options = b'8\001'
  _globals['_FEATUREUSAGEINFO'].fields_by_name['project_id']._loaded_options = None
  _globals['_FEATUREUSAGEINFO'].fields_by_name['project_id']._serialized_options = b'\232\354,\tprojectID'
  _globals['_FEATUREUSAGEINFO'].fields_by_name['room_id']._loaded_options = None
  _globals['_FEATUREUSAGEINFO'].fields_by_name['room_id']._serialized_options = b'\232\354,\006roomID'
  _globals['_FEATUREUSAGEINFO'].fields_by_name['participant_id']._loaded_options = None
  _globals['_FEATUREUSAGEINFO'].fields_by_name['participant_id']._serialized_options = b'\232\354,\rparticipantID'
  _globals['_FEATUREUSAGEINFO'].fields_by_name['track_id']._loaded_options = None
  _globals['_FEATUREUSAGEINFO'].fields_by_name['track_id']._serialized_options = b'\232\354,\007trackID'
  _globals['_APICALLINFO'].fields_by_name['project_id']._loaded_options = None
  _globals['_APICALLINFO'].fields_by_name['project_id']._serialized_options = b'\232\354,\tprojectID'
  _globals['_APICALLINFO'].fields_by_name['node_id']._loaded_options = None
  _globals['_APICALLINFO'].fields_by_name['node_id']._serialized_options = b'\232\354,\006nodeID'
  _globals['_APICALLINFO'].fields_by_name['room_id']._loaded_options = None
  _globals['_APICALLINFO'].fields_by_name['room_id']._serialized_options = b'\232\354,\006roomID'
  _globals['_APICALLINFO'].fields_by_name['participant_id']._loaded_options = None
  _globals['_APICALLINFO'].fields_by_name['participant_id']._serialized_options = b'\232\354,\rparticipantID'
  _globals['_APICALLINFO'].fields_by_name['track_id']._loaded_options = None
  _globals['_APICALLINFO'].fields_by_name['track_id']._serialized_options = b'\232\354,\007trackID'
  _globals['_WEBHOOKINFO'].fields_by_name['event_id']._loaded_options = None
  _globals['_WEBHOOKINFO'].fields_by_name['event_id']._serialized_options = b'\232\354,\007eventID'
  _globals['_WEBHOOKINFO'].fields_by_name['project_id']._loaded_options = None
  _globals['_WEBHOOKINFO'].fields_by_name['project_id']._serialized_options = b'\232\354,\tprojectID'
  _globals['_WEBHOOKINFO'].fields_by_name['room_id']._loaded_options = None
  _globals['_WEBHOOKINFO'].fields_by_name['room_id']._serialized_options = b'\232\354,\006roomID'
  _globals['_WEBHOOKINFO'].fields_by_name['participant_id']._loaded_options = None
  _globals['_WEBHOOKINFO'].fields_by_name['participant_id']._serialized_options = b'\232\354,\rparticipantID'
  _globals['_WEBHOOKINFO'].fields_by_name['track_id']._loaded_options = None
  _globals['_WEBHOOKINFO'].fields_by_name['track_id']._serialized_options = b'\232\354,\007trackID'
  _globals['_WEBHOOKINFO'].fields_by_name['egress_id']._loaded_options = None
  _globals['_WEBHOOKINFO'].fields_by_name['egress_id']._serialized_options = b'\232\354,\010egressID'
  _globals['_WEBHOOKINFO'].fields_by_name['ingress_id']._loaded_options = None
  _globals['_WEBHOOKINFO'].fields_by_name['ingress_id']._serialized_options = b'\232\354,\tingressID'
  _globals['_STREAMTYPE']._serialized_start=5888
  _globals['_STREAMTYPE']._serialized_end=5930
  _globals['_ANALYTICSEVENTTYPE']._serialized_start=5933
  _globals['_ANALYTICSEVENTTYPE']._serialized_end=7027
  ...
  _globals['_ANALYTICSSTAT']._serialized_end=1136
  _globals['_ANALYTICSSTATS']._serialized_start=1138
  _globals['_ANALYTICSSTATS']._serialized_end=1193
  _globals['_ANALYTICSCLIENTMETA']._serialized_start=1196
  _globals['_ANALYTICSCLIENTMETA']._serialized_end=1478
  _globals['_ANALYTICSEVENT']._serialized_start=1481
  _globals['_ANALYTICSEVENT']._serialized_end=2800
  _globals['_ANALYTICSEVENTS']._serialized_start=2802
  _globals['_ANALYTICSEVENTS']._serialized_end=2860
  _globals['_ANALYTICSROOMPARTICIPANT']._serialized_start=2863
  _globals['_ANALYTICSROOMPARTICIPANT']._serialized_end=3027
  _globals['_ANALYTICSROOM']._serialized_start=3030
  _globals['_ANALYTICSROOM']._serialized_end=3211
  _globals['_ANALYTICSNODEROOMS']._serialized_start=3214
  _globals['_ANALYTICSNODEROOMS']._serialized_end=3374
  _globals['_REPORTINFO']._serialized_start=3376
  _globals['_REPORTINFO']._serialized_end=3451
  _globals['_TIMERANGE']._serialized_start=3453
  _globals['_TIMERANGE']._serialized_end=3558
  _globals['_FEATUREUSAGEINFO']._serialized_start=3561
  _globals['_FEATUREUSAGEINFO']._serialized_end=4086
  _globals['_FEATUREUSAGEINFO_FEATUREINFOENTRY']._serialized_start=3927
  _globals['_FEATUREUSAGEINFO_FEATUREINFOENTRY']._serialized_end=3977
  _globals['_FEATUREUSAGEINFO_FEATURE']._serialized_start=3979
  _globals['_FEATUREUSAGEINFO_FEATURE']._serialized_end=4086
  _globals['_APICALLREQUEST']._serialized_start=4089
  _globals['_APICALLREQUEST']._serialized_end=4780
  _globals['_APICALLINFO']._serialized_start=4783
  _globals['_APICALLINFO']._serialized_end=5227
  _globals['_WEBHOOKINFO']._serialized_start=5230
  _globals['_WEBHOOKINFO']._serialized_end=5886
