...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_UPDATEPARTICIPANTMETADATA'].fields_by_name['metadata']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  _globals['_UPDATEPARTICIPANTMETADATA'].fields_by_name['name']._loaded_options = None
  _globals['_UPDATEPARTICIPANTMETADATA'].fields_by_name['name']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  _globals['_UPDATEPARTICIPANTMETADATA'].fields_by_name['attributes']._loaded_options = None
  _globals['_UPDATEPARTICIPANTMETADATA'].fields_by_name['attributes']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  ...
  _globals['_JOINREQUEST'].fields_by_name['metadata']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  _globals['_JOINREQUEST'].fields_by_name['participant_attributes']._loaded_options = None
  _globals['_JOINREQUEST'].fields_by_name['participant_attributes']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
