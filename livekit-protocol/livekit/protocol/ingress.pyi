...
class IngressAudioEncodingOptions(_message.Message):
    ...
    disable_dtx: bool
    channels: int
    def __init__(self, audio_codec: _Optional[_Union[_models.AudioCodec, str]] = ..., bitrate: _Optional[int] = ..., disable_dtx: _Optional[bool] = ..., channels: _Optional[int] = ...) -> None: ...
