...
class MetricsRecordingHeader(_message.Message):
    __slots__ = ("room_id", "duration", "start_time", "room_tags", "room_name", "room_start_time", "job_id", "simulated", "redaction_enabled")
