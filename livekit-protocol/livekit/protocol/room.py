...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CREATEROOMREQUEST_TAGSENTRY']._loaded_options = None
  ...
  _globals['_CREATEROOMREQUEST'].fields_by_name['metadata']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  ...
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['metadata']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['name']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['attributes']._loaded_options = None
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['attributes']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  ...
  _globals['_UPDATEROOMMETADATAREQUEST'].fields_by_name['metadata']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  ...
  _globals['_ROOMCONFIGURATION'].fields_by_name['metadata']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  ...
  _globals['_ROOMPARTICIPANTIDENTITY']._serialized_end=1186
  _globals['_REMOVEPARTICIPANTRESPONSE']._serialized_start=1188
  _globals['_REMOVEPARTICIPANTRESPONSE']._serialized_end=1215
  _globals['_MUTEROOMTRACKREQUEST']._serialized_start=1217
  _globals['_MUTEROOMTRACKREQUEST']._serialized_end=1305
  _globals['_MUTEROOMTRACKRESPONSE']._serialized_start=1307
  _globals['_MUTEROOMTRACKRESPONSE']._serialized_end=1365
  _globals['_UPDATEPARTICIPANTREQUEST']._serialized_start=1368
  _globals['_UPDATEPARTICIPANTREQUEST']._serialized_end=1746
  _globals['_UPDATEPARTICIPANTREQUEST_ATTRIBUTESENTRY']._serialized_start=1697
  _globals['_UPDATEPARTICIPANTREQUEST_ATTRIBUTESENTRY']._serialized_end=1746
  _globals['_UPDATESUBSCRIPTIONSREQUEST']._serialized_start=1749
  _globals['_UPDATESUBSCRIPTIONSREQUEST']._serialized_end=1904
  _globals['_UPDATESUBSCRIPTIONSRESPONSE']._serialized_start=1906
  _globals['_UPDATESUBSCRIPTIONSRESPONSE']._serialized_end=1935
  _globals['_SENDDATAREQUEST']._serialized_start=1938
  _globals['_SENDDATAREQUEST']._serialized_end=2130
  _globals['_SENDDATARESPONSE']._serialized_start=2132
  _globals['_SENDDATARESPONSE']._serialized_end=2150
  _globals['_UPDATEROOMMETADATAREQUEST']._serialized_start=2152
  _globals['_UPDATEROOMMETADATAREQUEST']._serialized_end=2249
  _globals['_ROOMCONFIGURATION']._serialized_start=2252
  _globals['_ROOMCONFIGURATION']._serialized_end=2671
  _globals['_ROOMCONFIGURATION_TAGSENTRY']._serialized_start=577
  _globals['_ROOMCONFIGURATION_TAGSENTRY']._serialized_end=620
  _globals['_FORWARDPARTICIPANTREQUEST']._serialized_start=2673
  _globals['_FORWARDPARTICIPANTREQUEST']._serialized_end=2758
  _globals['_FORWARDPARTICIPANTRESPONSE']._serialized_start=2760
  _globals['_FORWARDPARTICIPANTRESPONSE']._serialized_end=2788
  _globals['_MOVEPARTICIPANTREQUEST']._serialized_start=2790
  _globals['_MOVEPARTICIPANTREQUEST']._serialized_end=2872
  _globals['_MOVEPARTICIPANTRESPONSE']._serialized_start=2874
  _globals['_MOVEPARTICIPANTRESPONSE']._serialized_end=2899
  _globals['_PERFORMRPCREQUEST']._serialized_start=2901
  _globals['_PERFORMRPCREQUEST']._serialized_end=3026
  _globals['_PERFORMRPCRESPONSE']._serialized_start=3028
  _globals['_PERFORMRPCRESPONSE']._serialized_end=3065
  _globals['_ROOMSERVICE']._serialized_start=3068
  _globals['_ROOMSERVICE']._serialized_end=4190
