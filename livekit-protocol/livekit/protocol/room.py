...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CREATEROOMREQUEST'].fields_by_name['metadata']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  ...
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['metadata']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['name']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['attributes']._loaded_options = None
  _globals['_UPDATEPARTICIPANTREQUEST'].fields_by_name['attributes']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  ...
  _globals['_UPDATEROOMMETADATAREQUEST'].fields_by_name['metadata']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  ...
  _globals['_ROOMCONFIGURATION'].fields_by_name['metadata']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
