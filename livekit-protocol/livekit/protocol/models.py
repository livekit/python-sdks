...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PARTICIPANTPERMISSION.fields_by_name['recorder']._options = None
  _PARTICIPANTPERMISSION.fields_by_name['recorder']._serialized_options = b'\030\001'
  _PARTICIPANTPERMISSION.fields_by_name['agent']._options = None
  _PARTICIPANTPERMISSION.fields_by_name['agent']._serialized_options = b'\030\001'
  _PARTICIPANTINFO_ATTRIBUTESENTRY._options = None
  _PARTICIPANTINFO_ATTRIBUTESENTRY._serialized_options = b'8\001'
  _DATAPACKET.fields_by_name['kind']._options = None
  _DATAPACKET.fields_by_name['kind']._serialized_options = b'\030\001'
  _DATAPACKET.fields_by_name['speaker']._options = None
  _DATAPACKET.fields_by_name['speaker']._serialized_options = b'\030\001'
  _USERPACKET.fields_by_name['participant_sid']._options = None
  _USERPACKET.fields_by_name['participant_sid']._serialized_options = b'\030\001'
  _USERPACKET.fields_by_name['participant_identity']._options = None
  _USERPACKET.fields_by_name['participant_identity']._serialized_options = b'\030\001'
  _USERPACKET.fields_by_name['destination_sids']._options = None
  _USERPACKET.fields_by_name['destination_sids']._serialized_options = b'\030\001'
  _USERPACKET.fields_by_name['destination_identities']._options = None
  _USERPACKET.fields_by_name['destination_identities']._serialized_options = b'\030\001'
