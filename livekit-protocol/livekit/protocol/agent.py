...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_JOB_ATTRIBUTESENTRY']._loaded_options = None
  _globals['_JOB_ATTRIBUTESENTRY']._serialized_options = b'8\001'
  _globals['_JOB'].fields_by_name['dispatch_id']._loaded_options = None
  ...
  _globals['_JOB'].fields_by_name['metadata']._serialized_options = b'\300P\001'
  _globals['_JOB'].fields_by_name['attributes']._loaded_options = None
  _globals['_JOB'].fields_by_name['attributes']._serialized_options = b'\300P\001'
  _globals['_JOBSTATE'].fields_by_name['worker_id']._loaded_options = None
  _globals['_JOBSTATE'].fields_by_name['worker_id']._serialized_options = b'\272P\010workerID'
  _globals['_JOBSTATE'].fields_by_name['agent_id']._loaded_options = None
  _globals['_JOBSTATE'].fields_by_name['agent_id']._serialized_options = b'\272P\007agentID'
  _globals['_REGISTERWORKERRESPONSE'].fields_by_name['worker_id']._loaded_options = None
  ...
  _globals['_AVAILABILITYRESPONSE'].fields_by_name['job_id']._loaded_options = None
  _globals['_AVAILABILITYRESPONSE'].fields_by_name['job_id']._serialized_options = b'\272P\005jobID'
  _globals['_UPDATEJOBSTATUS'].fields_by_name['job_id']._loaded_options = None
  _globals['_UPDATEJOBSTATUS'].fields_by_name['job_id']._serialized_options = b'\272P\005jobID'
  _globals['_JOBTERMINATION'].fields_by_name['job_id']._loaded_options = None
  _globals['_JOBTERMINATION'].fields_by_name['job_id']._serialized_options = b'\272P\005jobID'
  _globals['_JOBTYPE']._serialized_start=2750
  _globals['_JOBTYPE']._serialized_end=2810
  _globals['_WORKERSTATUS']._serialized_start=2812
  _globals['_WORKERSTATUS']._serialized_end=2857
  _globals['_JOBSTATUS']._serialized_start=2859
  _globals['_JOBSTATUS']._serialized_end=2933
  _globals['_JOB']._serialized_start=77
  _globals['_JOB']._serialized_end=537
  _globals['_JOB_ATTRIBUTESENTRY']._serialized_start=472
  _globals['_JOB_ATTRIBUTESENTRY']._serialized_end=521
  _globals['_JOBSTATE']._serialized_start=540
  _globals['_JOBSTATE']._serialized_end=751
  _globals['_WORKERMESSAGE']._serialized_start=754
  _globals['_WORKERMESSAGE']._serialized_end=1130
  _globals['_SERVERMESSAGE']._serialized_start=1133
  _globals['_SERVERMESSAGE']._serialized_end=1397
  _globals['_SIMULATEJOBREQUEST']._serialized_start=1400
  _globals['_SIMULATEJOBREQUEST']._serialized_end=1528
  _globals['_WORKERPING']._serialized_start=1530
  _globals['_WORKERPING']._serialized_end=1561
  _globals['_WORKERPONG']._serialized_start=1563
  _globals['_WORKERPONG']._serialized_end=1618
  _globals['_REGISTERWORKERREQUEST']._serialized_start=1621
  _globals['_REGISTERWORKERREQUEST']._serialized_end=1855
  _globals['_REGISTERWORKERRESPONSE']._serialized_start=1857
  _globals['_REGISTERWORKERRESPONSE']._serialized_end=1955
  _globals['_MIGRATEJOBREQUEST']._serialized_start=1957
  _globals['_MIGRATEJOBREQUEST']._serialized_end=1993
  _globals['_AVAILABILITYREQUEST']._serialized_start=1995
  _globals['_AVAILABILITYREQUEST']._serialized_end=2061
  _globals['_AVAILABILITYRESPONSE']._serialized_start=2064
  _globals['_AVAILABILITYRESPONSE']._serialized_end=2413
  _globals['_AVAILABILITYRESPONSE_PARTICIPANTATTRIBUTESENTRY']._serialized_start=2353
  _globals['_AVAILABILITYRESPONSE_PARTICIPANTATTRIBUTESENTRY']._serialized_end=2413
  _globals['_UPDATEJOBSTATUS']._serialized_start=2415
  _globals['_UPDATEJOBSTATUS']._serialized_end=2509
  _globals['_UPDATEWORKERSTATUS']._serialized_start=2511
  _globals['_UPDATEWORKERSTATUS']._serialized_end=2619
  _globals['_JOBASSIGNMENT']._serialized_start=2621
  _globals['_JOBASSIGNMENT']._serialized_end=2704
  _globals['_JOBTERMINATION']._serialized_start=2706
  _globals['_JOBTERMINATION']._serialized_end=2748
