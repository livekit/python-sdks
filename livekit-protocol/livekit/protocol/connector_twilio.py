...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CONNECTTWILIOCALLREQUEST'].fields_by_name['participant_name']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  _globals['_CONNECTTWILIOCALLREQUEST'].fields_by_name['participant_metadata']._loaded_options = None
  _globals['_CONNECTTWILIOCALLREQUEST'].fields_by_name['participant_metadata']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
  _globals['_CONNECTTWILIOCALLREQUEST'].fields_by_name['participant_attributes']._loaded_options = None
  _globals['_CONNECTTWILIOCALLREQUEST'].fields_by_name['participant_attributes']._serialized_options = b'\250P\001\262P\036<redacted ({{ .Size }} bytes)>'
