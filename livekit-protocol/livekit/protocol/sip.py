...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CREATESIPTRUNKREQUEST.fields_by_name['inbound_numbers_regex']._options = None
  _CREATESIPTRUNKREQUEST.fields_by_name['inbound_numbers_regex']._serialized_options = b'\030\001'
  _CREATESIPTRUNKREQUEST._options = None
  _CREATESIPTRUNKREQUEST._serialized_options = b'\030\001'
  _SIPTRUNKINFO.fields_by_name['inbound_numbers_regex']._options = None
  _SIPTRUNKINFO.fields_by_name['inbound_numbers_regex']._serialized_options = b'\030\001'
  _SIPTRUNKINFO._options = None
  _SIPTRUNKINFO._serialized_options = b'\030\001'
  _LISTSIPTRUNKREQUEST._options = None
  _LISTSIPTRUNKREQUEST._serialized_options = b'\030\001'
  _LISTSIPTRUNKRESPONSE._options = None
  _LISTSIPTRUNKRESPONSE._serialized_options = b'\030\001'
  _CREATESIPDISPATCHRULEREQUEST_ATTRIBUTESENTRY._options = None
  _CREATESIPDISPATCHRULEREQUEST_ATTRIBUTESENTRY._serialized_options = b'8\001'
  _SIPDISPATCHRULEINFO_ATTRIBUTESENTRY._options = None
  _SIPDISPATCHRULEINFO_ATTRIBUTESENTRY._serialized_options = b'8\001'
  _CREATESIPPARTICIPANTREQUEST_PARTICIPANTATTRIBUTESENTRY._options = None
  _CREATESIPPARTICIPANTREQUEST_PARTICIPANTATTRIBUTESENTRY._serialized_options = b'8\001'
  _SIP.methods_by_name['CreateSIPTrunk']._options = None
  _SIP.methods_by_name['CreateSIPTrunk']._serialized_options = b'\210\002\001'
  _SIP.methods_by_name['ListSIPTrunk']._options = None
  _SIP.methods_by_name['ListSIPTrunk']._serialized_options = b'\210\002\001'
