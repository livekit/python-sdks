...
class EotSettings(_message.Message):
    ...
    def __init__(self, detection_interval: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
...
class InterruptionInferenceResponse(_message.Message):
    ...
    stats: InferenceStats
    def __init__(self, is_interruption: _Optional[bool] = ..., probabilities: _Optional[_Iterable[float]] = ..., stats: _Optional[_Union[InferenceStats, _Mapping]] = ...) -> None: ...
...
class InterruptionPrediction(_message.Message):
    ...
    probabilities: _containers.RepeatedScalarFieldContainer[float]
    inference_stats: InferenceStats
    def __init__(self, is_interruption: _Optional[bool] = ..., probabilities: _Optional[_Iterable[float]] = ..., inference_stats: _Optional[_Union[InferenceStats, _Mapping]] = ...) -> None: ...
