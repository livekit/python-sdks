...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_CALLUPDATED'].fields_by_name['id']._options = None
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_CALLUPDATED'].fields_by_name['id']._serialized_options = b'\272P\002ID'
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_CALLUPDATED'].fields_by_name['call_id']._options = None
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_CALLUPDATED'].fields_by_name['call_id']._serialized_options = b'\272P\006callID'
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_ENDED'].fields_by_name['id']._options = None
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_ENDED'].fields_by_name['id']._serialized_options = b'\272P\002ID'
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_ENDED'].fields_by_name['call_id']._options = None
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_ENDED'].fields_by_name['call_id']._serialized_options = b'\272P\006callID'
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_REPLYUPDATED'].fields_by_name['update_ids']._options = None
  ...
  _globals['_AGENTSESSIONEVENT_TOOLEXECUTIONUPDATED_REPLYUPDATED'].fields_by_name['speech_id']._options = None
