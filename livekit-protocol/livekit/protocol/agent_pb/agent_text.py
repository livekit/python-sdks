...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    4,
    '',
    'agent/livekit_agent_text.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TEXTMESSAGEREQUEST'].fields_by_name['message_id']._loaded_options = None
  _globals['_TEXTMESSAGEREQUEST'].fields_by_name['message_id']._serialized_options = b'\232\354,\tmessageID'
  _globals['_TEXTMESSAGEREQUEST'].fields_by_name['session_id']._loaded_options = None
  _globals['_TEXTMESSAGEREQUEST'].fields_by_name['session_id']._serialized_options = b'\232\354,\tsessionID'
  _globals['_TEXTMESSAGERESPONSE'].fields_by_name['message_id']._loaded_options = None
  _globals['_TEXTMESSAGERESPONSE'].fields_by_name['message_id']._serialized_options = b'\232\354,\tmessageID'
  _globals['_TEXTMESSAGERESPONSE'].fields_by_name['session_id']._loaded_options = None
  _globals['_TEXTMESSAGERESPONSE'].fields_by_name['session_id']._serialized_options = b'\232\354,\tsessionID'
  _globals['_TEXTMESSAGEERRORCODE']._serialized_start=1026
  _globals['_TEXTMESSAGEERRORCODE']._serialized_end=1141
  _globals['_TEXTMESSAGEREQUEST']._serialized_start=107
  _globals['_TEXTMESSAGEREQUEST']._serialized_end=329
  _globals['_TEXTMESSAGERESPONSE']._serialized_start=332
  _globals['_TEXTMESSAGERESPONSE']._serialized_end=710
  _globals['_TEXTMESSAGECOMPLETE']._serialized_start=713
  _globals['_TEXTMESSAGECOMPLETE']._serialized_end=853
  _globals['_AGENTSESSIONSTATE']._serialized_start=855
  _globals['_AGENTSESSIONSTATE']._serialized_end=936
  _globals['_TEXTMESSAGEERROR']._serialized_start=938
  _globals['_TEXTMESSAGEERROR']._serialized_end=1024
