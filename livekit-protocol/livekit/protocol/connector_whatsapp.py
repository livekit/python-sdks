...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DIALWHATSAPPCALLREQUEST'].fields_by_name['whatsapp_to_phone_number']._serialized_options = b'\300P\001'
  _globals['_DIALWHATSAPPCALLREQUEST'].fields_by_name['whatsapp_api_key']._loaded_options = None
  _globals['_DIALWHATSAPPCALLREQUEST'].fields_by_name['whatsapp_api_key']._serialized_options = b'\300P\002'
  _globals['_DIALWHATSAPPCALLREQUEST'].fields_by_name['participant_name']._loaded_options = None
  _globals['_DIALWHATSAPPCALLREQUEST'].fields_by_name['participant_name']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  _globals['_DIALWHATSAPPCALLREQUEST'].fields_by_name['participant_metadata']._loaded_options = None
  _globals['_DIALWHATSAPPCALLREQUEST'].fields_by_name['participant_metadata']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  _globals['_DIALWHATSAPPCALLREQUEST'].fields_by_name['participant_attributes']._loaded_options = None
  _globals['_DIALWHATSAPPCALLREQUEST'].fields_by_name['participant_attributes']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  ...
  _globals['_DISCONNECTWHATSAPPCALLREQUEST'].fields_by_name['whatsapp_api_key']._serialized_options = b'\300P\002'
  ...
  _globals['_ACCEPTWHATSAPPCALLREQUEST'].fields_by_name['whatsapp_api_key']._serialized_options = b'\300P\002'
  ...
  _globals['_ACCEPTWHATSAPPCALLREQUEST'].fields_by_name['participant_name']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  _globals['_ACCEPTWHATSAPPCALLREQUEST'].fields_by_name['participant_metadata']._loaded_options = None
  _globals['_ACCEPTWHATSAPPCALLREQUEST'].fields_by_name['participant_metadata']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  _globals['_ACCEPTWHATSAPPCALLREQUEST'].fields_by_name['participant_attributes']._loaded_options = None
  _globals['_ACCEPTWHATSAPPCALLREQUEST'].fields_by_name['participant_attributes']._serialized_options = b'\262P\036<redacted ({{ .Size }} bytes)>\300P\001'
  ...
  _globals['_WHATSAPPCALLDIRECTION']._serialized_start=2426
  _globals['_WHATSAPPCALLDIRECTION']._serialized_end=2524
  ...
  _globals['_CONNECTWHATSAPPCALLREQUEST']._serialized_start=1270
  _globals['_CONNECTWHATSAPPCALLREQUEST']._serialized_end=1414
  _globals['_CONNECTWHATSAPPCALLRESPONSE']._serialized_start=1416
  _globals['_CONNECTWHATSAPPCALLRESPONSE']._serialized_end=1445
  _globals['_ACCEPTWHATSAPPCALLREQUEST']._serialized_start=1448
  _globals['_ACCEPTWHATSAPPCALLREQUEST']._serialized_end=2263
  ...
  _globals['_ACCEPTWHATSAPPCALLRESPONSE']._serialized_start=2265
  _globals['_ACCEPTWHATSAPPCALLRESPONSE']._serialized_end=2312
  _globals['_WHATSAPPCALL']._serialized_start=2314
  _globals['_WHATSAPPCALL']._serialized_end=2424
