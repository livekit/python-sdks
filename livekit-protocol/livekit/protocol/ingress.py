...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CREATEINGRESSREQUEST.fields_by_name['bypass_transcoding']._options = None
  _CREATEINGRESSREQUEST.fields_by_name['bypass_transcoding']._serialized_options = b'\030\001'
  _INGRESSINFO.fields_by_name['bypass_transcoding']._options = None
  _INGRESSINFO.fields_by_name['bypass_transcoding']._serialized_options = b'\030\001'
  _UPDATEINGRESSREQUEST.fields_by_name['bypass_transcoding']._options = None
  _UPDATEINGRESSREQUEST.fields_by_name['bypass_transcoding']._serialized_options = b'\030\001'
