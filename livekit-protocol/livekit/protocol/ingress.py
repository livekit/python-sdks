...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CREATEINGRESSREQUEST'].fields_by_name['participant_name']._loaded_options = None
  _globals['_CREATEINGRESSREQUEST'].fields_by_name['participant_name']._serialized_options = b'\210\354,\001'
  _globals['_CREATEINGRESSREQUEST'].fields_by_name['participant_metadata']._loaded_options = None
  ...
  _globals['_INGRESSINFO'].fields_by_name['ingress_id']._loaded_options = None
  _globals['_INGRESSINFO'].fields_by_name['ingress_id']._serialized_options = b'\232\354,\tingressID'
  ...
  _globals['_INGRESSINFO'].fields_by_name['participant_name']._loaded_options = None
  _globals['_INGRESSINFO'].fields_by_name['participant_name']._serialized_options = b'\210\354,\001'
  _globals['_INGRESSINFO'].fields_by_name['participant_metadata']._loaded_options = None
  ...
  _globals['_INGRESSSTATE'].fields_by_name['room_id']._loaded_options = None
  _globals['_INGRESSSTATE'].fields_by_name['room_id']._serialized_options = b'\232\354,\006roomID'
  _globals['_INGRESSSTATE'].fields_by_name['resource_id']._loaded_options = None
  _globals['_INGRESSSTATE'].fields_by_name['resource_id']._serialized_options = b'\232\354,\nresourceID'
  _globals['_UPDATEINGRESSREQUEST'].fields_by_name['ingress_id']._loaded_options = None
  _globals['_UPDATEINGRESSREQUEST'].fields_by_name['ingress_id']._serialized_options = b'\232\354,\tingressID'
  _globals['_UPDATEINGRESSREQUEST'].fields_by_name['participant_name']._loaded_options = None
  _globals['_UPDATEINGRESSREQUEST'].fields_by_name['participant_name']._serialized_options = b'\210\354,\001'
  _globals['_UPDATEINGRESSREQUEST'].fields_by_name['participant_metadata']._loaded_options = None
  ...
  _globals['_LISTINGRESSREQUEST'].fields_by_name['ingress_id']._loaded_options = None
  _globals['_LISTINGRESSREQUEST'].fields_by_name['ingress_id']._serialized_options = b'\232\354,\tingressID'
  _globals['_DELETEINGRESSREQUEST'].fields_by_name['ingress_id']._loaded_options = None
  _globals['_DELETEINGRESSREQUEST'].fields_by_name['ingress_id']._serialized_options = b'\232\354,\tingressID'
  _globals['_INGRESSINPUT']._serialized_start=3189
  _globals['_INGRESSINPUT']._serialized_end=3250
  _globals['_INGRESSAUDIOENCODINGPRESET']._serialized_start=3252
  _globals['_INGRESSAUDIOENCODINGPRESET']._serialized_end=3325
  _globals['_INGRESSVIDEOENCODINGPRESET']._serialized_start=3328
  _globals['_INGRESSVIDEOENCODINGPRESET']._serialized_end=3716
  ...
  _globals['_INGRESSINFO']._serialized_end=1770
  _globals['_INGRESSSTATE']._serialized_start=1773
  _globals['_INGRESSSTATE']._serialized_end=2215
  _globals['_INGRESSSTATE_STATUS']._serialized_start=2092
  _globals['_INGRESSSTATE_STATUS']._serialized_end=2215
  _globals['_INPUTVIDEOSTATE']._serialized_start=2217
  _globals['_INPUTVIDEOSTATE']._serialized_end=2328
  _globals['_INPUTAUDIOSTATE']._serialized_start=2330
  _globals['_INPUTAUDIOSTATE']._serialized_end=2430
  _globals['_UPDATEINGRESSREQUEST']._serialized_start=2433
  _globals['_UPDATEINGRESSREQUEST']._serialized_end=2895
  _globals['_LISTINGRESSREQUEST']._serialized_start=2897
  _globals['_LISTINGRESSREQUEST']._serialized_end=3017
  _globals['_LISTINGRESSRESPONSE']._serialized_start=3019
  _globals['_LISTINGRESSRESPONSE']._serialized_end=3128
  _globals['_DELETEINGRESSREQUEST']._serialized_start=3130
  _globals['_DELETEINGRESSREQUEST']._serialized_end=3187
  _globals['_INGRESS']._serialized_start=3719
  _globals['_INGRESS']._serialized_end=4012
