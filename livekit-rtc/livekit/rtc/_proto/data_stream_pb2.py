...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TEXTSTREAMINFO_ATTRIBUTESENTRY._options = None
  _TEXTSTREAMINFO_ATTRIBUTESENTRY._serialized_options = b'8\001'
  _BYTESTREAMINFO_ATTRIBUTESENTRY._options = None
  _BYTESTREAMINFO_ATTRIBUTESENTRY._serialized_options = b'8\001'
  _STREAMTEXTOPTIONS_ATTRIBUTESENTRY._options = None
  _STREAMTEXTOPTIONS_ATTRIBUTESENTRY._serialized_options = b'8\001'
  _STREAMBYTEOPTIONS_ATTRIBUTESENTRY._options = None
  _STREAMBYTEOPTIONS_ATTRIBUTESENTRY._serialized_options = b'8\001'
