...
class FfiRequest(_message.Message):
    ...
    **Useful things know when collaborating on the protocol:**
    ...
    PUBLISH_DATA_TRACK_FIELD_NUMBER: _builtins.int
    LOCAL_DATA_TRACK_TRY_PUSH_FIELD_NUMBER: _builtins.int
    LOCAL_DATA_TRACK_UNPUBLISH_FIELD_NUMBER: _builtins.int
    LOCAL_DATA_TRACK_IS_PUBLISHED_FIELD_NUMBER: _builtins.int
    SUBSCRIBE_DATA_TRACK_FIELD_NUMBER: _builtins.int
    REMOTE_DATA_TRACK_IS_PUBLISHED_FIELD_NUMBER: _builtins.int
    DATA_TRACK_STREAM_READ_FIELD_NUMBER: _builtins.int
    REMOTE_DATA_TRACK_SET_PIPELINE_OPTIONS_FIELD_NUMBER: _builtins.int
    SIMULATE_SCENARIO_FIELD_NUMBER: _builtins.int
    NEW_PLATFORM_AUDIO_FIELD_NUMBER: _builtins.int
    GET_AUDIO_DEVICES_FIELD_NUMBER: _builtins.int
    SET_RECORDING_DEVICE_FIELD_NUMBER: _builtins.int
    SET_PLAYOUT_DEVICE_FIELD_NUMBER: _builtins.int
    START_RECORDING_FIELD_NUMBER: _builtins.int
    STOP_RECORDING_FIELD_NUMBER: _builtins.int
    READY_FOR_ROOM_EVENT_FIELD_NUMBER: _builtins.int
    @_builtins.property
    ...
    @_builtins.property
    def publish_data_track(self) -> _data_track_pb2.PublishDataTrackRequest:
        """Data Track (local)"""

    @_builtins.property
    def local_data_track_try_push(self) -> _data_track_pb2.LocalDataTrackTryPushRequest: ...
    @_builtins.property
    def local_data_track_unpublish(self) -> _data_track_pb2.LocalDataTrackUnpublishRequest: ...
    @_builtins.property
    def local_data_track_is_published(self) -> _data_track_pb2.LocalDataTrackIsPublishedRequest: ...
    @_builtins.property
    def subscribe_data_track(self) -> _data_track_pb2.SubscribeDataTrackRequest:
        """Data Track (remote)"""

    @_builtins.property
    def remote_data_track_is_published(self) -> _data_track_pb2.RemoteDataTrackIsPublishedRequest: ...
    @_builtins.property
    def data_track_stream_read(self) -> _data_track_pb2.DataTrackStreamReadRequest: ...
    @_builtins.property
    def remote_data_track_set_pipeline_options(self) -> _data_track_pb2.RemoteDataTrackSetPipelineOptionsRequest: ...
    @_builtins.property
    def simulate_scenario(self) -> _room_pb2.SimulateScenarioRequest:
        """Reconnection / chaos testing"""

    @_builtins.property
    def new_platform_audio(self) -> _audio_frame_pb2.NewPlatformAudioRequest:
        """Platform Audio (ADM)"""

    @_builtins.property
    def get_audio_devices(self) -> _audio_frame_pb2.GetAudioDevicesRequest: ...
    @_builtins.property
    def set_recording_device(self) -> _audio_frame_pb2.SetRecordingDeviceRequest: ...
    @_builtins.property
    def set_playout_device(self) -> _audio_frame_pb2.SetPlayoutDeviceRequest: ...
    @_builtins.property
    def start_recording(self) -> _audio_frame_pb2.StartRecordingRequest: ...
    @_builtins.property
    def stop_recording(self) -> _audio_frame_pb2.StopRecordingRequest: ...
    @_builtins.property
    def ready_for_room_event(self) -> _room_pb2.ReadyForRoomEventRequest:
    ...
    def __init__(
        ...
        *,
        ...
        publish_data_track: _data_track_pb2.PublishDataTrackRequest | None = ...,
        local_data_track_try_push: _data_track_pb2.LocalDataTrackTryPushRequest | None = ...,
        local_data_track_unpublish: _data_track_pb2.LocalDataTrackUnpublishRequest | None = ...,
        local_data_track_is_published: _data_track_pb2.LocalDataTrackIsPublishedRequest | None = ...,
        subscribe_data_track: _data_track_pb2.SubscribeDataTrackRequest | None = ...,
        remote_data_track_is_published: _data_track_pb2.RemoteDataTrackIsPublishedRequest | None = ...,
        data_track_stream_read: _data_track_pb2.DataTrackStreamReadRequest | None = ...,
        remote_data_track_set_pipeline_options: _data_track_pb2.RemoteDataTrackSetPipelineOptionsRequest | None = ...,
        simulate_scenario: _room_pb2.SimulateScenarioRequest | None = ...,
        new_platform_audio: _audio_frame_pb2.NewPlatformAudioRequest | None = ...,
        get_audio_devices: _audio_frame_pb2.GetAudioDevicesRequest | None = ...,
        set_recording_device: _audio_frame_pb2.SetRecordingDeviceRequest | None = ...,
        set_playout_device: _audio_frame_pb2.SetPlayoutDeviceRequest | None = ...,
        start_recording: _audio_frame_pb2.StartRecordingRequest | None = ...,
        stop_recording: _audio_frame_pb2.StopRecordingRequest | None = ...,
        ready_for_room_event: _room_pb2.ReadyForRoomEventRequest | None = ...,
    ) -> None: ...
...
class FfiResponse(_message.Message):
    ...
    @_builtins.property
    def publish_data_track(self) -> _data_track_pb2.PublishDataTrackResponse:
        """Data Track (local)"""

    @_builtins.property
    def local_data_track_try_push(self) -> _data_track_pb2.LocalDataTrackTryPushResponse: ...
    @_builtins.property
    def local_data_track_unpublish(self) -> _data_track_pb2.LocalDataTrackUnpublishResponse: ...
    @_builtins.property
    def local_data_track_is_published(self) -> _data_track_pb2.LocalDataTrackIsPublishedResponse: ...
    @_builtins.property
    def subscribe_data_track(self) -> _data_track_pb2.SubscribeDataTrackResponse:
        """Data Track (remote)"""

    @_builtins.property
    def remote_data_track_is_published(self) -> _data_track_pb2.RemoteDataTrackIsPublishedResponse: ...
    @_builtins.property
    def data_track_stream_read(self) -> _data_track_pb2.DataTrackStreamReadResponse: ...
    @_builtins.property
    def remote_data_track_set_pipeline_options(self) -> _data_track_pb2.RemoteDataTrackSetPipelineOptionsResponse: ...
    @_builtins.property
    def simulate_scenario(self) -> _room_pb2.SimulateScenarioResponse:
        """Reconnection / chaos testing"""

    @_builtins.property
    def new_platform_audio(self) -> _audio_frame_pb2.NewPlatformAudioResponse:
        """Platform Audio (ADM)"""

    @_builtins.property
    def get_audio_devices(self) -> _audio_frame_pb2.GetAudioDevicesResponse: ...
    @_builtins.property
    def set_recording_device(self) -> _audio_frame_pb2.SetRecordingDeviceResponse: ...
    @_builtins.property
    def set_playout_device(self) -> _audio_frame_pb2.SetPlayoutDeviceResponse: ...
    @_builtins.property
    def start_recording(self) -> _audio_frame_pb2.StartRecordingResponse: ...
    @_builtins.property
    def stop_recording(self) -> _audio_frame_pb2.StopRecordingResponse: ...
    @_builtins.property
    def ready_for_room_event(self) -> _room_pb2.ReadyForRoomEventResponse:
        """Room event ready signal"""
    ...
    def __init__(
        ...
        *,
        ...
        publish_data_track: _data_track_pb2.PublishDataTrackResponse | None = ...,
        local_data_track_try_push: _data_track_pb2.LocalDataTrackTryPushResponse | None = ...,
        local_data_track_unpublish: _data_track_pb2.LocalDataTrackUnpublishResponse | None = ...,
        local_data_track_is_published: _data_track_pb2.LocalDataTrackIsPublishedResponse | None = ...,
        subscribe_data_track: _data_track_pb2.SubscribeDataTrackResponse | None = ...,
        remote_data_track_is_published: _data_track_pb2.RemoteDataTrackIsPublishedResponse | None = ...,
        data_track_stream_read: _data_track_pb2.DataTrackStreamReadResponse | None = ...,
        remote_data_track_set_pipeline_options: _data_track_pb2.RemoteDataTrackSetPipelineOptionsResponse | None = ...,
        simulate_scenario: _room_pb2.SimulateScenarioResponse | None = ...,
        new_platform_audio: _audio_frame_pb2.NewPlatformAudioResponse | None = ...,
        get_audio_devices: _audio_frame_pb2.GetAudioDevicesResponse | None = ...,
        set_recording_device: _audio_frame_pb2.SetRecordingDeviceResponse | None = ...,
        set_playout_device: _audio_frame_pb2.SetPlayoutDeviceResponse | None = ...,
        start_recording: _audio_frame_pb2.StartRecordingResponse | None = ...,
        stop_recording: _audio_frame_pb2.StopRecordingResponse | None = ...,
        ready_for_room_event: _room_pb2.ReadyForRoomEventResponse | None = ...,
    ) -> None: ...
...
class FfiEvent(_message.Message):
    ...
    SEND_BYTES_FIELD_NUMBER: _builtins.int
    PUBLISH_DATA_TRACK_FIELD_NUMBER: _builtins.int
    DATA_TRACK_STREAM_EVENT_FIELD_NUMBER: _builtins.int
    SIMULATE_SCENARIO_FIELD_NUMBER: _builtins.int
    @_builtins.property
    ...
    @_builtins.property
    def publish_data_track(self) -> _data_track_pb2.PublishDataTrackCallback:
        """Data Track (local)"""

    @_builtins.property
    def data_track_stream_event(self) -> _data_track_pb2.DataTrackStreamEvent:
        """Data Track (remote)"""

    @_builtins.property
    def simulate_scenario(self) -> _room_pb2.SimulateScenarioCallback: ...
    def __init__(
        self,
        *,
