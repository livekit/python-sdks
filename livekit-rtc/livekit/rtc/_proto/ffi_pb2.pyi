...
class FfiRequest(google.protobuf.message.Message):
    ...
    **Useful things know when collaborating on the protocol:**
    ...
    DEFINE_SCHEMA_FIELD_NUMBER: builtins.int
    GET_SCHEMA_FIELD_NUMBER: builtins.int
    CAPTURE_ENCODED_VIDEO_FRAME_FIELD_NUMBER: builtins.int
    TAKE_ENCODED_VIDEO_SOURCE_FEEDBACK_FIELD_NUMBER: builtins.int
    ...
    NEW_CAPTURE_SOURCE_FIELD_NUMBER: builtins.int
    ...
    @property
    def define_schema(self) -> data_track_pb2.DefineSchemaRequest:
        """Data Track (schemas)"""

    @property
    def get_schema(self) -> data_track_pb2.GetSchemaRequest: ...
    @property
    def capture_encoded_video_frame(self) -> video_frame_pb2.CaptureEncodedVideoFrameRequest:
        """Pre-encoded video"""

    @property
    def take_encoded_video_source_feedback(self) -> video_frame_pb2.TakeEncodedVideoSourceFeedbackRequest: ...
    @property
    ...
    @property
    def new_capture_source(self) -> capture_pb2.NewCaptureSourceRequest:
        """Capture sources (livekit-capture; requires the `capture` feature)"""

    @property
    def start_capture(self) -> capture_pb2.StartCaptureRequest: ...
    @property
    def stop_capture(self) -> capture_pb2.StopCaptureRequest: ...
    def __init__(
        self,
        *,
        ...
        define_schema: data_track_pb2.DefineSchemaRequest | None = ...,
        get_schema: data_track_pb2.GetSchemaRequest | None = ...,
        capture_encoded_video_frame: video_frame_pb2.CaptureEncodedVideoFrameRequest | None = ...,
        take_encoded_video_source_feedback: video_frame_pb2.TakeEncodedVideoSourceFeedbackRequest | None = ...,
        ...
        new_capture_source: capture_pb2.NewCaptureSourceRequest | None = ...,
        start_capture: capture_pb2.StartCaptureRequest | None = ...,
        stop_capture: capture_pb2.StopCaptureRequest | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["apm_process_reverse_stream", b"apm_process_reverse_stream", "apm_process_stream", b"apm_process_stream", "apm_set_stream_delay", b"apm_set_stream_delay", "audio_stream_from_participant", b"audio_stream_from_participant", "byte_read_all", b"byte_read_all", "byte_read_incremental", b"byte_read_incremental", "byte_stream_close", b"byte_stream_close", "byte_stream_open", b"byte_stream_open", "byte_stream_write", b"byte_stream_write", "byte_write_to_file", b"byte_write_to_file", "capture_audio_frame", b"capture_audio_frame", "capture_encoded_video_frame", b"capture_encoded_video_frame", "capture_video_frame", b"capture_video_frame", "clear_audio_buffer", b"clear_audio_buffer", "connect", b"connect", "create_audio_track", b"create_audio_track", "create_video_track", b"create_video_track", "data_track_stream_read", b"data_track_stream_read", "define_schema", b"define_schema", "disconnect", b"disconnect", "dispose", b"dispose", "e2ee", b"e2ee", "edit_chat_message", b"edit_chat_message", "enable_remote_track", b"enable_remote_track", "enable_remote_track_publication", b"enable_remote_track_publication", "flush_sox_resampler", b"flush_sox_resampler", "get_audio_devices", b"get_audio_devices", "get_schema", b"get_schema", "get_session_stats", b"get_session_stats", "get_stats", b"get_stats", "load_audio_filter_plugin", b"load_audio_filter_plugin", "local_data_track_is_published", b"local_data_track_is_published", "local_data_track_try_push", b"local_data_track_try_push", "local_data_track_unpublish", b"local_data_track_unpublish", "local_track_mute", b"local_track_mute", "message", b"message", "new_apm", b"new_apm", "new_audio_resampler", b"new_audio_resampler", "new_audio_source", b"new_audio_source", "new_audio_stream", b"new_audio_stream", "new_capture_source", b"new_capture_source", "new_platform_audio", b"new_platform_audio", "new_sox_resampler", b"new_sox_resampler", "new_video_source", b"new_video_source", "new_video_stream", b"new_video_stream", "perform_rpc", b"perform_rpc", "publish_data", b"publish_data", "publish_data_track", b"publish_data_track", "publish_sip_dtmf", b"publish_sip_dtmf", "publish_track", b"publish_track", "publish_transcription", b"publish_transcription", "push_sox_resampler", b"push_sox_resampler", "ready_for_room_event", b"ready_for_room_event", "register_rpc_method", b"register_rpc_method", "remix_and_resample", b"remix_and_resample", "remote_data_track_is_published", b"remote_data_track_is_published", "remote_data_track_set_pipeline_options", b"remote_data_track_set_pipeline_options", "rpc_method_invocation_response", b"rpc_method_invocation_response", "send_bytes", b"send_bytes", "send_chat_message", b"send_chat_message", "send_file", b"send_file", "send_stream_chunk", b"send_stream_chunk", "send_stream_header", b"send_stream_header", "send_stream_trailer", b"send_stream_trailer", "send_text", b"send_text", "set_data_channel_buffered_amount_low_threshold", b"set_data_channel_buffered_amount_low_threshold", "set_local_attributes", b"set_local_attributes", "set_local_metadata", b"set_local_metadata", "set_local_name", b"set_local_name", "set_playout_device", b"set_playout_device", "set_recording_device", b"set_recording_device", "set_remote_track_publication_quality", b"set_remote_track_publication_quality", "set_subscribed", b"set_subscribed", "set_track_subscription_permissions", b"set_track_subscription_permissions", "simulate_scenario", b"simulate_scenario", "start_capture", b"start_capture", "start_recording", b"start_recording", "stop_capture", b"stop_capture", "stop_recording", b"stop_recording", "subscribe_data_track", b"subscribe_data_track", "take_encoded_video_source_feedback", b"take_encoded_video_source_feedback", "text_read_all", b"text_read_all", "text_read_incremental", b"text_read_incremental", "text_stream_close", b"text_stream_close", "text_stream_open", b"text_stream_open", "text_stream_write", b"text_stream_write", "unpublish_track", b"unpublish_track", "unregister_rpc_method", b"unregister_rpc_method", "update_remote_track_publication_dimension", b"update_remote_track_publication_dimension", "video_convert", b"video_convert", "video_stream_from_participant", b"video_stream_from_participant"]) -> builtins.bool: ...
...
class FfiResponse(google.protobuf.message.Message):
    ...
    @property
    def define_schema(self) -> data_track_pb2.DefineSchemaResponse:
        """Data Track (schemas)"""

    @property
    def get_schema(self) -> data_track_pb2.GetSchemaResponse: ...
    @property
    def capture_encoded_video_frame(self) -> video_frame_pb2.CaptureEncodedVideoFrameResponse:
        """Pre-encoded video"""

    @property
    def take_encoded_video_source_feedback(self) -> video_frame_pb2.TakeEncodedVideoSourceFeedbackResponse: ...
    @property
    ...
    @property
    def new_capture_source(self) -> capture_pb2.NewCaptureSourceResponse:
        """Capture sources (livekit-capture; requires the `capture` feature)"""

    @property
    def start_capture(self) -> capture_pb2.StartCaptureResponse: ...
    @property
    def stop_capture(self) -> capture_pb2.StopCaptureResponse: ...
    def __init__(
        self,
        *,
        ...
        define_schema: data_track_pb2.DefineSchemaResponse | None = ...,
        get_schema: data_track_pb2.GetSchemaResponse | None = ...,
        capture_encoded_video_frame: video_frame_pb2.CaptureEncodedVideoFrameResponse | None = ...,
        take_encoded_video_source_feedback: video_frame_pb2.TakeEncodedVideoSourceFeedbackResponse | None = ...,
        ...
        new_capture_source: capture_pb2.NewCaptureSourceResponse | None = ...,
        start_capture: capture_pb2.StartCaptureResponse | None = ...,
        stop_capture: capture_pb2.StopCaptureResponse | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["apm_process_reverse_stream", b"apm_process_reverse_stream", "apm_process_stream", b"apm_process_stream", "apm_set_stream_delay", b"apm_set_stream_delay", "audio_stream_from_participant", b"audio_stream_from_participant", "byte_read_all", b"byte_read_all", "byte_read_incremental", b"byte_read_incremental", "byte_stream_close", b"byte_stream_close", "byte_stream_open", b"byte_stream_open", "byte_stream_write", b"byte_stream_write", "byte_write_to_file", b"byte_write_to_file", "capture_audio_frame", b"capture_audio_frame", "capture_encoded_video_frame", b"capture_encoded_video_frame", "capture_video_frame", b"capture_video_frame", "clear_audio_buffer", b"clear_audio_buffer", "connect", b"connect", "create_audio_track", b"create_audio_track", "create_video_track", b"create_video_track", "data_track_stream_read", b"data_track_stream_read", "define_schema", b"define_schema", "disconnect", b"disconnect", "dispose", b"dispose", "e2ee", b"e2ee", "enable_remote_track", b"enable_remote_track", "enable_remote_track_publication", b"enable_remote_track_publication", "flush_sox_resampler", b"flush_sox_resampler", "get_audio_devices", b"get_audio_devices", "get_schema", b"get_schema", "get_session_stats", b"get_session_stats", "get_stats", b"get_stats", "load_audio_filter_plugin", b"load_audio_filter_plugin", "local_data_track_is_published", b"local_data_track_is_published", "local_data_track_try_push", b"local_data_track_try_push", "local_data_track_unpublish", b"local_data_track_unpublish", "local_track_mute", b"local_track_mute", "message", b"message", "new_apm", b"new_apm", "new_audio_resampler", b"new_audio_resampler", "new_audio_source", b"new_audio_source", "new_audio_stream", b"new_audio_stream", "new_capture_source", b"new_capture_source", "new_platform_audio", b"new_platform_audio", "new_sox_resampler", b"new_sox_resampler", "new_video_source", b"new_video_source", "new_video_stream", b"new_video_stream", "perform_rpc", b"perform_rpc", "publish_data", b"publish_data", "publish_data_track", b"publish_data_track", "publish_sip_dtmf", b"publish_sip_dtmf", "publish_track", b"publish_track", "publish_transcription", b"publish_transcription", "push_sox_resampler", b"push_sox_resampler", "ready_for_room_event", b"ready_for_room_event", "register_rpc_method", b"register_rpc_method", "remix_and_resample", b"remix_and_resample", "remote_data_track_is_published", b"remote_data_track_is_published", "remote_data_track_set_pipeline_options", b"remote_data_track_set_pipeline_options", "rpc_method_invocation_response", b"rpc_method_invocation_response", "send_bytes", b"send_bytes", "send_chat_message", b"send_chat_message", "send_file", b"send_file", "send_stream_chunk", b"send_stream_chunk", "send_stream_header", b"send_stream_header", "send_stream_trailer", b"send_stream_trailer", "send_text", b"send_text", "set_data_channel_buffered_amount_low_threshold", b"set_data_channel_buffered_amount_low_threshold", "set_local_attributes", b"set_local_attributes", "set_local_metadata", b"set_local_metadata", "set_local_name", b"set_local_name", "set_playout_device", b"set_playout_device", "set_recording_device", b"set_recording_device", "set_remote_track_publication_quality", b"set_remote_track_publication_quality", "set_subscribed", b"set_subscribed", "set_track_subscription_permissions", b"set_track_subscription_permissions", "simulate_scenario", b"simulate_scenario", "start_capture", b"start_capture", "start_recording", b"start_recording", "stop_capture", b"stop_capture", "stop_recording", b"stop_recording", "subscribe_data_track", b"subscribe_data_track", "take_encoded_video_source_feedback", b"take_encoded_video_source_feedback", "text_read_all", b"text_read_all", "text_read_incremental", b"text_read_incremental", "text_stream_close", b"text_stream_close", "text_stream_open", b"text_stream_open", "text_stream_write", b"text_stream_write", "unpublish_track", b"unpublish_track", "unregister_rpc_method", b"unregister_rpc_method", "update_remote_track_publication_dimension", b"update_remote_track_publication_dimension", "video_convert", b"video_convert", "video_stream_from_participant", b"video_stream_from_participant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["apm_process_reverse_stream", b"apm_process_reverse_stream", "apm_process_stream", b"apm_process_stream", "apm_set_stream_delay", b"apm_set_stream_delay", "audio_stream_from_participant", b"audio_stream_from_participant", "byte_read_all", b"byte_read_all", "byte_read_incremental", b"byte_read_incremental", "byte_stream_close", b"byte_stream_close", "byte_stream_open", b"byte_stream_open", "byte_stream_write", b"byte_stream_write", "byte_write_to_file", b"byte_write_to_file", "capture_audio_frame", b"capture_audio_frame", "capture_encoded_video_frame", b"capture_encoded_video_frame", "capture_video_frame", b"capture_video_frame", "clear_audio_buffer", b"clear_audio_buffer", "connect", b"connect", "create_audio_track", b"create_audio_track", "create_video_track", b"create_video_track", "data_track_stream_read", b"data_track_stream_read", "define_schema", b"define_schema", "disconnect", b"disconnect", "dispose", b"dispose", "e2ee", b"e2ee", "enable_remote_track", b"enable_remote_track", "enable_remote_track_publication", b"enable_remote_track_publication", "flush_sox_resampler", b"flush_sox_resampler", "get_audio_devices", b"get_audio_devices", "get_schema", b"get_schema", "get_session_stats", b"get_session_stats", "get_stats", b"get_stats", "load_audio_filter_plugin", b"load_audio_filter_plugin", "local_data_track_is_published", b"local_data_track_is_published", "local_data_track_try_push", b"local_data_track_try_push", "local_data_track_unpublish", b"local_data_track_unpublish", "local_track_mute", b"local_track_mute", "message", b"message", "new_apm", b"new_apm", "new_audio_resampler", b"new_audio_resampler", "new_audio_source", b"new_audio_source", "new_audio_stream", b"new_audio_stream", "new_capture_source", b"new_capture_source", "new_platform_audio", b"new_platform_audio", "new_sox_resampler", b"new_sox_resampler", "new_video_source", b"new_video_source", "new_video_stream", b"new_video_stream", "perform_rpc", b"perform_rpc", "publish_data", b"publish_data", "publish_data_track", b"publish_data_track", "publish_sip_dtmf", b"publish_sip_dtmf", "publish_track", b"publish_track", "publish_transcription", b"publish_transcription", "push_sox_resampler", b"push_sox_resampler", "ready_for_room_event", b"ready_for_room_event", "register_rpc_method", b"register_rpc_method", "remix_and_resample", b"remix_and_resample", "remote_data_track_is_published", b"remote_data_track_is_published", "remote_data_track_set_pipeline_options", b"remote_data_track_set_pipeline_options", "rpc_method_invocation_response", b"rpc_method_invocation_response", "send_bytes", b"send_bytes", "send_chat_message", b"send_chat_message", "send_file", b"send_file", "send_stream_chunk", b"send_stream_chunk", "send_stream_header", b"send_stream_header", "send_stream_trailer", b"send_stream_trailer", "send_text", b"send_text", "set_data_channel_buffered_amount_low_threshold", b"set_data_channel_buffered_amount_low_threshold", "set_local_attributes", b"set_local_attributes", "set_local_metadata", b"set_local_metadata", "set_local_name", b"set_local_name", "set_playout_device", b"set_playout_device", "set_recording_device", b"set_recording_device", "set_remote_track_publication_quality", b"set_remote_track_publication_quality", "set_subscribed", b"set_subscribed", "set_track_subscription_permissions", b"set_track_subscription_permissions", "simulate_scenario", b"simulate_scenario", "start_capture", b"start_capture", "start_recording", b"start_recording", "stop_capture", b"stop_capture", "stop_recording", b"stop_recording", "subscribe_data_track", b"subscribe_data_track", "take_encoded_video_source_feedback", b"take_encoded_video_source_feedback", "text_read_all", b"text_read_all", "text_read_incremental", b"text_read_incremental", "text_stream_close", b"text_stream_close", "text_stream_open", b"text_stream_open", "text_stream_write", b"text_stream_write", "unpublish_track", b"unpublish_track", "unregister_rpc_method", b"unregister_rpc_method", "update_remote_track_publication_dimension", b"update_remote_track_publication_dimension", "video_convert", b"video_convert", "video_stream_from_participant", b"video_stream_from_participant"]) -> None: ...
...
class FfiEvent(google.protobuf.message.Message):
    ...
    GET_SCHEMA_FIELD_NUMBER: builtins.int
    NEW_CAPTURE_SOURCE_FIELD_NUMBER: builtins.int
    CAPTURE_SOURCE_EVENT_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def define_schema(self) -> data_track_pb2.DefineSchemaCallback:
        """Data Track (schemas)"""

    @property
    def get_schema(self) -> data_track_pb2.GetSchemaCallback: ...
    @property
    def new_capture_source(self) -> capture_pb2.NewCaptureSourceCallback:
        """Capture sources (livekit-capture; requires the `capture` feature)"""

    @property
    def capture_source_event(self) -> capture_pb2.CaptureSourceEvent: ...
    def __init__(
        self,
        *,
        ...
        define_schema: data_track_pb2.DefineSchemaCallback | None = ...,
        get_schema: data_track_pb2.GetSchemaCallback | None = ...,
        new_capture_source: capture_pb2.NewCaptureSourceCallback | None = ...,
        capture_source_event: capture_pb2.CaptureSourceEvent | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["audio_stream_event", b"audio_stream_event", "byte_stream_open", b"byte_stream_open", "byte_stream_reader_event", b"byte_stream_reader_event", "byte_stream_reader_read_all", b"byte_stream_reader_read_all", "byte_stream_reader_write_to_file", b"byte_stream_reader_write_to_file", "byte_stream_writer_close", b"byte_stream_writer_close", "byte_stream_writer_write", b"byte_stream_writer_write", "capture_audio_frame", b"capture_audio_frame", "capture_source_event", b"capture_source_event", "chat_message", b"chat_message", "connect", b"connect", "data_track_stream_event", b"data_track_stream_event", "define_schema", b"define_schema", "disconnect", b"disconnect", "dispose", b"dispose", "get_schema", b"get_schema", "get_session_stats", b"get_session_stats", "get_stats", b"get_stats", "logs", b"logs", "message", b"message", "new_capture_source", b"new_capture_source", "panic", b"panic", "perform_rpc", b"perform_rpc", "publish_data", b"publish_data", "publish_data_track", b"publish_data_track", "publish_sip_dtmf", b"publish_sip_dtmf", "publish_track", b"publish_track", "publish_transcription", b"publish_transcription", "room_event", b"room_event", "rpc_method_invocation", b"rpc_method_invocation", "send_bytes", b"send_bytes", "send_file", b"send_file", "send_stream_chunk", b"send_stream_chunk", "send_stream_header", b"send_stream_header", "send_stream_trailer", b"send_stream_trailer", "send_text", b"send_text", "set_local_attributes", b"set_local_attributes", "set_local_metadata", b"set_local_metadata", "set_local_name", b"set_local_name", "simulate_scenario", b"simulate_scenario", "text_stream_open", b"text_stream_open", "text_stream_reader_event", b"text_stream_reader_event", "text_stream_reader_read_all", b"text_stream_reader_read_all", "text_stream_writer_close", b"text_stream_writer_close", "text_stream_writer_write", b"text_stream_writer_write", "track_event", b"track_event", "unpublish_track", b"unpublish_track", "video_stream_event", b"video_stream_event"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["audio_stream_event", b"audio_stream_event", "byte_stream_open", b"byte_stream_open", "byte_stream_reader_event", b"byte_stream_reader_event", "byte_stream_reader_read_all", b"byte_stream_reader_read_all", "byte_stream_reader_write_to_file", b"byte_stream_reader_write_to_file", "byte_stream_writer_close", b"byte_stream_writer_close", "byte_stream_writer_write", b"byte_stream_writer_write", "capture_audio_frame", b"capture_audio_frame", "capture_source_event", b"capture_source_event", "chat_message", b"chat_message", "connect", b"connect", "data_track_stream_event", b"data_track_stream_event", "define_schema", b"define_schema", "disconnect", b"disconnect", "dispose", b"dispose", "get_schema", b"get_schema", "get_session_stats", b"get_session_stats", "get_stats", b"get_stats", "logs", b"logs", "message", b"message", "new_capture_source", b"new_capture_source", "panic", b"panic", "perform_rpc", b"perform_rpc", "publish_data", b"publish_data", "publish_data_track", b"publish_data_track", "publish_sip_dtmf", b"publish_sip_dtmf", "publish_track", b"publish_track", "publish_transcription", b"publish_transcription", "room_event", b"room_event", "rpc_method_invocation", b"rpc_method_invocation", "send_bytes", b"send_bytes", "send_file", b"send_file", "send_stream_chunk", b"send_stream_chunk", "send_stream_header", b"send_stream_header", "send_stream_trailer", b"send_stream_trailer", "send_text", b"send_text", "set_local_attributes", b"set_local_attributes", "set_local_metadata", b"set_local_metadata", "set_local_name", b"set_local_name", "simulate_scenario", b"simulate_scenario", "text_stream_open", b"text_stream_open", "text_stream_reader_event", b"text_stream_reader_event", "text_stream_reader_read_all", b"text_stream_reader_read_all", "text_stream_writer_close", b"text_stream_writer_close", "text_stream_writer_write", b"text_stream_writer_write", "track_event", b"track_event", "unpublish_track", b"unpublish_track", "video_stream_event", b"video_stream_event"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["message", b"message"]) -> typing.Literal["room_event", "track_event", "video_stream_event", "audio_stream_event", "connect", "disconnect", "dispose", "publish_track", "unpublish_track", "publish_data", "publish_transcription", "capture_audio_frame", "set_local_metadata", "set_local_name", "set_local_attributes", "get_stats", "logs", "get_session_stats", "panic", "publish_sip_dtmf", "chat_message", "perform_rpc", "rpc_method_invocation", "send_stream_header", "send_stream_chunk", "send_stream_trailer", "byte_stream_reader_event", "byte_stream_reader_read_all", "byte_stream_reader_write_to_file", "byte_stream_open", "byte_stream_writer_write", "byte_stream_writer_close", "send_file", "text_stream_reader_event", "text_stream_reader_read_all", "text_stream_open", "text_stream_writer_write", "text_stream_writer_close", "send_text", "send_bytes", "publish_data_track", "data_track_stream_event", "simulate_scenario", "define_schema", "get_schema", "new_capture_source", "capture_source_event"] | None: ...
