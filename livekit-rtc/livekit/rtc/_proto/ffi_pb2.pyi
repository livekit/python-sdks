...
class FfiRequest(google.protobuf.message.Message):
    ...
    **Useful things know when collaborating on the protocol:**
    ...
    DATA_TRACK_SUBSCRIPTION_READ_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def data_track_subscription_read(self) -> data_track_pb2.DataTrackSubscriptionReadRequest: ...
    def __init__(
        self,
        *,
...
class FfiResponse(google.protobuf.message.Message):
    ...
    @property
    def data_track_subscription_read(self) -> data_track_pb2.DataTrackSubscriptionReadResponse: ...
    def __init__(
        self,
        *,
        ...
        data_track_subscription_read: data_track_pb2.DataTrackSubscriptionReadResponse | None = ...,
    ) -> None: ...
...
class FfiEvent(google.protobuf.message.Message):
    ...
    PUBLISH_DATA_TRACK_FIELD_NUMBER: builtins.int
    SUBSCRIBE_DATA_TRACK_FIELD_NUMBER: builtins.int
    DATA_TRACK_SUBSCRIPTION_EVENT_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def subscribe_data_track(self) -> data_track_pb2.SubscribeDataTrackCallback:
        """Data Track (remote)"""

    @property
    def data_track_subscription_event(self) -> data_track_pb2.DataTrackSubscriptionEvent: ...
    def __init__(
        self,
        *,
