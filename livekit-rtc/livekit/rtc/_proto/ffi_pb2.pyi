...
class FfiRequest(google.protobuf.message.Message):
    ...
    **Useful things know when collaborating on the protocol:**
    ...
    NEW_AEC_FIELD_NUMBER: builtins.int
    CANCEL_ECHO_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def new_aec(self) -> audio_frame_pb2.NewAecRequest: ...
    @property
    def cancel_echo(self) -> audio_frame_pb2.CancelEchoRequest: ...
    def __init__(
        self,
        *,
...
class FfiResponse(google.protobuf.message.Message):
    ...
    @property
    def new_aec(self) -> audio_frame_pb2.NewAecResponse: ...
    @property
    def cancel_echo(self) -> audio_frame_pb2.CancelEchoResponse: ...
    def __init__(
        self,
        *,
        ...
        new_aec: audio_frame_pb2.NewAecResponse | None = ...,
        cancel_echo: audio_frame_pb2.CancelEchoResponse | None = ...,
    ) -> None: ...
