...
class TransportStats(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_dtls_state",b"_dtls_state"]) -> typing.Optional[typing_extensions.Literal["dtls_state"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_ice_state",b"_ice_state"]) -> typing.Optional[typing_extensions.Literal["ice_state"]]: ...
...
class IceCandidateStats(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_candidate_type",b"_candidate_type"]) -> typing.Optional[typing_extensions.Literal["candidate_type"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_relay_protocol",b"_relay_protocol"]) -> typing.Optional[typing_extensions.Literal["relay_protocol"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_tcp_type",b"_tcp_type"]) -> typing.Optional[typing_extensions.Literal["tcp_type"]]: ...
