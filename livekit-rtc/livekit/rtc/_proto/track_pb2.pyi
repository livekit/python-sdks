...
class _FrameMetadataFeature:
    ValueType = _typing.NewType("ValueType", _builtins.int)
    V: _TypeAlias = ValueType  # noqa: Y015

class _FrameMetadataFeatureEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_FrameMetadataFeature.ValueType], _builtins.type):
    DESCRIPTOR: _descriptor.EnumDescriptor
...
Global___FrameMetadataFeature: _TypeAlias = FrameMetadataFeature  # noqa: Y015
...
class TrackPublicationInfo(_message.Message):
    ...
    @_builtins.property
    def frame_metadata_features(self) -> _containers.RepeatedScalarFieldContainer[Global___FrameMetadataFeature.ValueType]: ...
    def __init__(
        self,
        *,
        ...
        frame_metadata_features: _abc.Iterable[Global___FrameMetadataFeature.ValueType] | None = ...,
    ) -> None: ...
