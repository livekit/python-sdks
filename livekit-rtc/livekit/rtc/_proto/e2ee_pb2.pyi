...
class FrameCryptor(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        key_index: typing.Optional[builtins.int] = ...,
...
class KeyProviderOptions(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        shared_key: typing.Optional[builtins.bytes] = ...,
        ratchet_window_size: typing.Optional[builtins.int] = ...,
        ratchet_salt: typing.Optional[builtins.bytes] = ...,
        failure_tolerance: typing.Optional[builtins.int] = ...,
        ) -> None: ...
...
class E2eeOptions(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        encryption_type: typing.Optional[global___EncryptionType.ValueType] = ...,
        key_provider_options: typing.Optional[global___KeyProviderOptions] = ...,
        ) -> None: ...
...
class E2eeManagerGetFrameCryptorsResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        frame_cryptors: typing.Optional[typing.Iterable[global___FrameCryptor]] = ...,
        ) -> None: ...
...
class RatchetSharedKeyResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        new_key: typing.Optional[builtins.bytes] = ...,
        ) -> None: ...
...
class E2eeRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        manager_set_enabled: typing.Optional[global___E2eeManagerSetEnabledRequest] = ...,
        manager_get_frame_cryptors: typing.Optional[global___E2eeManagerGetFrameCryptorsRequest] = ...,
        cryptor_set_enabled: typing.Optional[global___FrameCryptorSetEnabledRequest] = ...,
        cryptor_set_key_index: typing.Optional[global___FrameCryptorSetKeyIndexRequest] = ...,
        set_shared_key: typing.Optional[global___SetSharedKeyRequest] = ...,
        ratchet_shared_key: typing.Optional[global___RatchetSharedKeyRequest] = ...,
        get_shared_key: typing.Optional[global___GetSharedKeyRequest] = ...,
        set_key: typing.Optional[global___SetKeyRequest] = ...,
        ratchet_key: typing.Optional[global___RatchetKeyRequest] = ...,
        get_key: typing.Optional[global___GetKeyRequest] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["message",b"message"]) -> typing.Optional[typing_extensions.Literal["manager_set_enabled","manager_get_frame_cryptors","cryptor_set_enabled","cryptor_set_key_index","set_shared_key","ratchet_shared_key","get_shared_key","set_key","ratchet_key","get_key"]]: ...
...
class E2eeResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        manager_set_enabled: typing.Optional[global___E2eeManagerSetEnabledResponse] = ...,
        manager_get_frame_cryptors: typing.Optional[global___E2eeManagerGetFrameCryptorsResponse] = ...,
        cryptor_set_enabled: typing.Optional[global___FrameCryptorSetEnabledResponse] = ...,
        cryptor_set_key_index: typing.Optional[global___FrameCryptorSetKeyIndexResponse] = ...,
        set_shared_key: typing.Optional[global___SetSharedKeyResponse] = ...,
        ratchet_shared_key: typing.Optional[global___RatchetSharedKeyResponse] = ...,
        get_shared_key: typing.Optional[global___GetSharedKeyResponse] = ...,
        set_key: typing.Optional[global___SetKeyResponse] = ...,
        ratchet_key: typing.Optional[global___RatchetKeyResponse] = ...,
        get_key: typing.Optional[global___GetKeyResponse] = ...,
        ) -> None: ...
