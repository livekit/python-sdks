...
class RoomOptions(google.protobuf.message.Message):
    ...
    @property
    def audio_filter_handles(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]: ...
    def __init__(
        self,
        *,
        ...
        audio_filter_handles: collections.abc.Iterable[builtins.int] | None = ...,
    ) -> None: ...
