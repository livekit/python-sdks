...
class SendChatMessageRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_sender_identity",b"_sender_identity","sender_identity",b"sender_identity"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_sender_identity",b"_sender_identity","destination_identities",b"destination_identities","local_participant_handle",b"local_participant_handle","message",b"message","sender_identity",b"sender_identity"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_sender_identity",b"_sender_identity"]) -> typing.Optional[typing_extensions.Literal["sender_identity"]]: ...
...
class EditChatMessageRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_sender_identity",b"_sender_identity","original_message",b"original_message","sender_identity",b"sender_identity"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_sender_identity",b"_sender_identity","destination_identities",b"destination_identities","edit_text",b"edit_text","local_participant_handle",b"local_participant_handle","original_message",b"original_message","sender_identity",b"sender_identity"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_sender_identity",b"_sender_identity"]) -> typing.Optional[typing_extensions.Literal["sender_identity"]]: ...
...
class SendChatMessageCallback(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_chat_message",b"_chat_message","_error",b"_error","chat_message",b"chat_message","error",b"error"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_chat_message",b"_chat_message","_error",b"_error","async_id",b"async_id","chat_message",b"chat_message","error",b"error"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_chat_message",b"_chat_message"]) -> typing.Optional[typing_extensions.Literal["chat_message"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_error",b"_error"]) -> typing.Optional[typing_extensions.Literal["error"]]: ...
...
class RtcConfig(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_continual_gathering_policy",b"_continual_gathering_policy"]) -> typing.Optional[typing_extensions.Literal["continual_gathering_policy"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_ice_transport_type",b"_ice_transport_type"]) -> typing.Optional[typing_extensions.Literal["ice_transport_type"]]: ...
...
class RoomOptions(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_e2ee",b"_e2ee"]) -> typing.Optional[typing_extensions.Literal["e2ee"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_rtc_config",b"_rtc_config"]) -> typing.Optional[typing_extensions.Literal["rtc_config"]]: ...
...
class RoomInfo(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_sid",b"_sid"]) -> typing.Optional[typing_extensions.Literal["sid"]]: ...
...
class ParticipantAttributesChanged(google.protobuf.message.Message):
    ...
    def attributes(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, typing.Text]: ...
    @property
    def changed_attributes(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, typing.Text]: ...
    def __init__(self,
        *,
        participant_identity: typing.Text = ...,
        attributes: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        changed_attributes: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        ) -> None: ...
...
class ChatMessage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_deleted",b"_deleted","_edit_timestamp",b"_edit_timestamp","_generated",b"_generated","deleted",b"deleted","edit_timestamp",b"edit_timestamp","generated",b"generated"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_deleted",b"_deleted","_edit_timestamp",b"_edit_timestamp","_generated",b"_generated","deleted",b"deleted","edit_timestamp",b"edit_timestamp","generated",b"generated","id",b"id","message",b"message","timestamp",b"timestamp"]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_edit_timestamp",b"_edit_timestamp"]) -> typing.Optional[typing_extensions.Literal["edit_timestamp"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_generated",b"_generated"]) -> typing.Optional[typing_extensions.Literal["generated"]]: ...
...
class SipDTMF(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_digit",b"_digit"]) -> typing.Optional[typing_extensions.Literal["digit"]]: ...
...
class TranscriptionReceived(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_participant_identity",b"_participant_identity"]) -> typing.Optional[typing_extensions.Literal["participant_identity"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_track_sid",b"_track_sid"]) -> typing.Optional[typing_extensions.Literal["track_sid"]]: ...
