...
class _SimulateScenarioKindEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_SimulateScenarioKind.ValueType], _builtins.type):
...
escalates to a full reconnect — exercising the resume→full escalation path.
"""
Global___SimulateScenarioKind: _TypeAlias = SimulateScenarioKind  # noqa: Y015

class _VideoEncoderBackend:
    ValueType = _typing.NewType("ValueType", _builtins.int)
    V: _TypeAlias = ValueType  # noqa: Y015

class _VideoEncoderBackendEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_VideoEncoderBackend.ValueType], _builtins.type):
    DESCRIPTOR: _descriptor.EnumDescriptor
...
Global___VideoEncoderBackend: _TypeAlias = VideoEncoderBackend  # noqa: Y015

class _DegradationPreference:
    ValueType = _typing.NewType("ValueType", _builtins.int)
    V: _TypeAlias = ValueType  # noqa: Y015

class _DegradationPreferenceEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_DegradationPreference.ValueType], _builtins.type):
    DESCRIPTOR: _descriptor.EnumDescriptor
...
if necessary to avoid overusing network and encoder resources.
"""
Global___DegradationPreference: _TypeAlias = DegradationPreference  # noqa: Y015
...
class SimulateScenarioRequest(_message.Message):
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["request_async_id", b"request_async_id", "room_handle", b"room_handle", "scenario", b"scenario"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["request_async_id", b"request_async_id", "room_handle", b"room_handle", "scenario", b"scenario"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...

Global___SimulateScenarioRequest: _TypeAlias = SimulateScenarioRequest  # noqa: Y015
...
Global___SimulateScenarioResponse: _TypeAlias = SimulateScenarioResponse  # noqa: Y015

@_typing.final
class SimulateScenarioCallback(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor
...
Global___SimulateScenarioCallback: _TypeAlias = SimulateScenarioCallback  # noqa: Y015
...
@_typing.final
class ReadyForRoomEventRequest(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["room_handle", b"room_handle"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["room_handle", b"room_handle"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...

Global___ReadyForRoomEventRequest: _TypeAlias = ReadyForRoomEventRequest  # noqa: Y015

@_typing.final
class ReadyForRoomEventResponse(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor
...
Global___ReadyForRoomEventResponse: _TypeAlias = ReadyForRoomEventResponse  # noqa: Y015
...
class TrackPublishOptions(_message.Message):
    ...
    FRAME_METADATA_FEATURES_FIELD_NUMBER: _builtins.int
    SCALABILITY_MODE_FIELD_NUMBER: _builtins.int
    VIDEO_ENCODER_FIELD_NUMBER: _builtins.int
    DEGRADATION_PREFERENCE_FIELD_NUMBER: _builtins.int
    ...
    @_builtins.property
    def frame_metadata_features(self) -> _containers.RepeatedScalarFieldContainer[_track_pb2.FrameMetadataFeature.ValueType]: ...
    def __init__(
        self,
        *,
        ...
        frame_metadata_features: _abc.Iterable[_track_pb2.FrameMetadataFeature.ValueType] | None = ...,
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["audio_encoding", b"audio_encoding", "degradation_preference", b"degradation_preference", "dtx", b"dtx", "preconnect_buffer", b"preconnect_buffer", "red", b"red", "scalability_mode", b"scalability_mode", "simulcast", b"simulcast", "source", b"source", "stream", b"stream", "video_codec", b"video_codec", "video_encoder", b"video_encoder", "video_encoding", b"video_encoding"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["audio_encoding", b"audio_encoding", "degradation_preference", b"degradation_preference", "dtx", b"dtx", "frame_metadata_features", b"frame_metadata_features", "preconnect_buffer", b"preconnect_buffer", "red", b"red", "scalability_mode", b"scalability_mode", "simulcast", b"simulcast", "source", b"source", "stream", b"stream", "video_codec", b"video_codec", "video_encoder", b"video_encoder", "video_encoding", b"video_encoding"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...
...
@_typing.final
class RoomDataStreamOptions(_message.Message):
    """Options controlling data stream behavior for the room."""

    DESCRIPTOR: _descriptor.Descriptor

    MAX_PAYLOAD_BYTE_LENGTH_FIELD_NUMBER: _builtins.int
    USE_LEGACY_CLIENT_IMPLEMENTATION_FIELD_NUMBER: _builtins.int
    max_payload_byte_length: _builtins.int
    ...
    """
    use_legacy_client_implementation: _builtins.bool
    ...
    def __init__(
        self,
        *,
        max_payload_byte_length: _builtins.int | None = ...,
        use_legacy_client_implementation: _builtins.bool | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["max_payload_byte_length", b"max_payload_byte_length", "use_legacy_client_implementation", b"use_legacy_client_implementation"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["max_payload_byte_length", b"max_payload_byte_length", "use_legacy_client_implementation", b"use_legacy_client_implementation"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...

Global___RoomDataStreamOptions: _TypeAlias = RoomDataStreamOptions  # noqa: Y015
...
class RoomOptions(_message.Message):
    ...
    DATA_STREAM_FIELD_NUMBER: _builtins.int
...
class RoomEvent(_message.Message):
    ...
    LOCAL_TRACK_REPUBLISHED_FIELD_NUMBER: _builtins.int
    room_handle: _builtins.int
    @_builtins.property
...
@_typing.final
class LocalTrackRepublished(_message.Message):
    ...
    PUBLICATION_HANDLE_FIELD_NUMBER: _builtins.int
    PREVIOUS_SID_FIELD_NUMBER: _builtins.int
    INFO_FIELD_NUMBER: _builtins.int
    publication_handle: _builtins.int
    previous_sid: _builtins.str
    @_builtins.property
    def info(self) -> _track_pb2.TrackPublicationInfo: ...
    def __init__(
        self,
        *,
        publication_handle: _builtins.int | None = ...,
        previous_sid: _builtins.str | None = ...,
        info: _track_pb2.TrackPublicationInfo | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["info", b"info", "previous_sid", b"previous_sid", "publication_handle", b"publication_handle"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["info", b"info", "previous_sid", b"previous_sid", "publication_handle", b"publication_handle"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...

Global___LocalTrackRepublished: _TypeAlias = LocalTrackRepublished  # noqa: Y015
