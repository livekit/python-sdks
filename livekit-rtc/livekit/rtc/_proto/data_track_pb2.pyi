...
@_typing.final
class RemoteDataTrackPipelineOptions(_message.Message):
    """Track-level options that configure how the incoming-frame pipeline reassembles packets for a remote data track."""

    DESCRIPTOR: _descriptor.Descriptor

    MAX_PARTIAL_FRAMES_FIELD_NUMBER: _builtins.int
    max_partial_frames: _builtins.int
    ...
    def __init__(
        self,
        *,
        max_partial_frames: _builtins.int | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["max_partial_frames", b"max_partial_frames"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["max_partial_frames", b"max_partial_frames"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...

Global___RemoteDataTrackPipelineOptions: _TypeAlias = RemoteDataTrackPipelineOptions  # noqa: Y015

@_typing.final
class RemoteDataTrackSetPipelineOptionsRequest(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor
...
Global___RemoteDataTrackSetPipelineOptionsRequest: _TypeAlias = RemoteDataTrackSetPipelineOptionsRequest  # noqa: Y015

@_typing.final
class RemoteDataTrackSetPipelineOptionsResponse(_message.Message):
    DESCRIPTOR: _descriptor.Descriptor
...
Global___RemoteDataTrackSetPipelineOptionsResponse: _TypeAlias = RemoteDataTrackSetPipelineOptionsResponse  # noqa: Y015
...
class DataTrackStreamReadResponse(_message.Message):
    ...
    EOS_EVENT_FIELD_NUMBER: _builtins.int
    @_builtins.property
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["eos_event", b"eos_event"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["eos_event", b"eos_event"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...
